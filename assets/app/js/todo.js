document.addEventListener('DOMContentLoaded', function() {
  ...
  let prepareView = function() {
    let container = document.createElement('div'),
        todo = document.createElement('ul'),
        completed = document.createElement('ul');
    todo.id = "todo";
    completed.id = "completed";
    todo.className = completed.className = "todo";
  ...
  Func.$('#add').addEventListener('click', function() {
  ...
  Func.$('#item').addEventListener('keydown', function (e) {
  ...
  let renderTodoList = function renderTodoList() {
  ...
  let addItem = (value) => {
    ...
    if (data.todo.includes(value)) {
      console.log('Entered task already exists');
  ...
  function completeItem() {
    ...
    let target = (id === 'todo') ? Func.$('#completed') : Func.$('#todo');
  ...
  function addItemToDOM(text, completed) {
    let list = (completed) ? Func.$('#completed') : Func.$('#todo');
